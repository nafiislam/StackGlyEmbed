...
feature_paths = {
    'Physico-Global': '/media/nafiislam/New Volume/For side thesis/all_features/Physicochemical_features/fasta_train_NGlyDE_original.csv',
    ...
    'ProtT5-XL-U50-Global': '/media/nafiislam/New Volume/For side thesis/all_features/ProtT5-XL-U50-Global/fasta_train_NGlyDE_original.csv',
    'ESM-2-Local': '/media/nafiislam/New Volume/For side thesis/all_features/ESM-2-Local/fasta_train_NGlyDE_original.csv',
...
feature_sets = [
    ['Physico-Global'], ['ProtT5-XL-U50-Local'], ['ProtT5-XL-U50-Global'], ['ESM-2-Local'], ['ESM-2-Global'], ['ProteinBert'],
    ['ESM-2-Global', 'Physico-Global'], ['ESM-2-Global', 'ProtT5-XL-U50-Local'], ['ESM-2-Global', 'ProtT5-XL-U50-Global'], ['ESM-2-Global', 'ESM-2-Local'], ['ESM-2-Global', 'ProteinBert'],
    ['ESM-2-Global', 'ProtT5-XL-U50-Local', 'Physico-Global'], ['ESM-2-Global', 'ProtT5-XL-U50-Local', 'ProtT5-XL-U50-Global'], ['ESM-2-Global', 'ProtT5-XL-U50-Local', 'ESM-2-Local'], ['ESM-2-Global', 'ProtT5-XL-U50-Local', 'ProteinBert'],
    ['ESM-2-Global', 'ProtT5-XL-U50-Local', 'ProteinBert', 'Physico-Global'], ['ESM-2-Global', 'ProtT5-XL-U50-Local', 'ProteinBert', 'ProtT5-XL-U50-Global'], ['ESM-2-Global', 'ProtT5-XL-U50-Local', 'ProteinBert', 'ESM-2-Local'],
    ['ESM-2-Global', 'ProtT5-XL-U50-Local', 'ProteinBert', 'Physico-Global', 'ProtT5-XL-U50-Global'], ['ESM-2-Global', 'ProtT5-XL-U50-Local', 'ProteinBert', 'Physico-Global', 'ESM-2-Local'],
    ['ESM-2-Global', 'ProtT5-XL-U50-Local', 'ProteinBert', 'Physico-Global', 'ESM-2-Local', 'ProtT5-XL-U50-Global']
]
...
with open('./results.csv', 'w') as f1:
    ...
    for features in feature_sets:
        ...
        file_path_Benchmark_embeddings = feature_paths['Physico-Global']
