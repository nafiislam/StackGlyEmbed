...
with open('./results.csv', 'w') as f1:
    ...
    csvWriter.writerow(['Classifier', 'Sensitivity', 'Specificity', 'Balanced Accuracy', 'Accuracy', 'Precision', 'F1-score', 'MCC', 'AUC', 'auPR'])
